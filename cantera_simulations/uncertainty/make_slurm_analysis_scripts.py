...
M = 50  # total number of times to run RMG
...
for i in range(0, M, N):
    ...
    jobfile.settings['--error'] = os.path.join(working_dir, f'ct_job_error{sbatch_index}.log')
    jobfile.settings['--output'] = os.path.join(working_dir, f'ct_job_output{sbatch_index}.log')
    ...
    content.append(f'python /scratch/westgroup/methanol/meOH-analysis/RMG-Py/analyze_temperatures.py $CT_FILE\n')
