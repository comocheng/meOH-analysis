...
def run_reactor(cti_file, t_array=[528], p_array=[75], v_array=[0.00424], h2_array=[0.75], co2_array=[0.5], 
    ...
    results_path = os.path.dirname(os.path.abspath(__file__)) + f'/{git_sha}_{git_msg}/{reactor_type_str}/{temp_str}/results'
    flux_path = os.path.dirname(os.path.abspath(__file__)) + f'/{git_sha}_{git_msg}/{reactor_type_str}/{temp_str}/flux_diagrams/{x_h2_str}/{x_CO_CO2_str}'
    try:  
...
cti_file = '/work/westgroup/ChrisB/meOH-synthesis_cantera/meOH-synthesis/other/mech_grabow_new.cti'
