...
def run reactor(cti_file, t_array=[528], p_array=[75], v_array=[0.00424], h2_array=[0.75], co2_array=[0.5], 
                rtol=1.0e-11, atol=1.0e-22, reactor_type=0):
    ...
    output_filename = f'Spinning_basket_RMG_Temp{temp}_area{cat_area}.csv'
